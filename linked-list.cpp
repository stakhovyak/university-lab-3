...
template <typename T>
void Linkedlist<T>::insertNode(int data,unsigned int pos)
{
  Node<T> *newNode = new Node<T>(data);
...
template <typename T>
void Linkedlist<T>::deleteNode(unsigned int pos)
{
  if (head == nullptr)
    {
...
template <typename T>
Node<T> *Linkedlist<T>::index(unsigned int index)
{
  Node<T> *current = this->head;
